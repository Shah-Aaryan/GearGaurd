...
export function EquipmentForm({ equipment, onClose }: EquipmentFormProps) {
  ...
  return (
    <div className="relative">
      {/* Sticky header with shadow when scrolling */}
      <div className="sticky top-0 z-10 bg-background pb-4 mb-4 border-b">
        <h2 className="text-xl font-semibold mb-2">
          {equipment ? "Edit Equipment" : "Add New Equipment"}
        </h2>
        <p className="text-sm text-muted-foreground">
          Fill in the equipment details below. All fields marked with * are required.
        </p>
      </div>
      ...
      <motion.form
        ...
        className="space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 hover:scrollbar-thumb-gray-400"
        style={{
          scrollbarWidth: 'thin',
      ...
      >
        ...
        {submitSuccess && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="rounded-lg bg-success/20 border border-success/30 p-4 sticky top-0 z-20 mb-4"
          >
        ...
        {submitError && (
          <motion.div
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            className="rounded-lg bg-destructive/20 border border-destructive/30 p-4 sticky top-0 z-20 mb-4"
          >
